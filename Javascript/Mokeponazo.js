...
let botonAgua
let botonTierra
//Creamos la variable botones, para que puedan funcionar los botones de tierra, aguan y fuego de cada una de las mascotas, que al individualizarlas por mascota, s�lo funcionaba la primera (en caso de que tuviera ataques repetidos) cuando se crearon:
let botones = []
...
function mostrarAtaques(ataques) {
	...
	//introducimos el concepto querySelectorAll: le decimos que seleccione TODOS los elementos de esa clase, en este caso botones. O sea un GetEmelementbyID, pero para toda una clase. Lo hacemos a trav�es de clase y no a trav�s de Id porque ser�a una mala pr�ctica, dicen.
